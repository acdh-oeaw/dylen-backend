...
public class TestFixture {
    ...
    public static final EgoNetwork NETWORK_2 = EgoNetwork.of(EGO_NETWORK_ID_2,
            EGO_NETWORK_YEAR_2, NODES, EDGES, NETWORK_METRIC);
    ...
    public static final TargetWord TARGET_WORD_WITH_ID = TargetWord.of(TARGETWORD_ID, TARGETWORD_TEXT, "NOUN", CORPUS_NAME, SOURCE_NAME, ImmutableList.of(NETWORK_2, NETWORK));
